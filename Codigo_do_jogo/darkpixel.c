...
int main(void)
{
    ...
    Music music = LoadMusicStream("assets/audio/Beep2.mp3");
    PlayMusicStream(music);

    // firabollsong

    Sound firebollsong = LoadSound("assets/audio/firabollsong.mp3");
    Sound hit_boneco = LoadSound("assets/audio/hit_boneco.mp3");
    //------------------------------------------------------------------------------------------
    // Mapas do jogo

    Texture2D Background = LoadTexture("assets/img/background2.png");
    ...
    Texture2D barra_life_boss = LoadTexture("assets/img/barra_life_boss.png");
    ...
    Texture2D Life = LoadTexture("assets/img/Life.png");
    ...
    Texture2D fireboll = LoadTexture("assets/img/bollFire.png");
    ...
    // florhit
    Texture2D florhit = LoadTexture("assets/img/florhit.png");
    ...
    Texture2D Inseto = LoadTexture("assets/img/inseto.png");
    ...
    Texture2D Boss = LoadTexture("assets/img/bossbig.png");
    ...
    Texture2D spritesheet = LoadTexture("assets/img/mago.png"); // Carrega uma lista de um personagem
    ...
    do
    {
        ...
        if (person.morto == false)
        {
            if (IsKeyDown(KEY_D))
            {
                ...
                { // Verifica se tempo decorrido é maior ou igual ao tempo que o quadro atual deve ser exibido.

                    currentFrame++; // Incrementa o índice do quadro atual.

                    if (currentFrame >= frameCount)
                    { // Verifica se o índice do quadro atual ultrapassou o número total de quadros na animação. Se sim, volta ao primeiro quadro.
                        currentFrame = 0;
                    }
        ...
        if (currentFrameBackground == 1 && inseto.morto == false)
        {
            ...
            { // Verifica se tempo decorrido é maior ou igual ao tempo que o quadro atual deve ser exibido.
                ...
                if (currentFrameInseto >= frameCountInseto)
                { // Verifica se o índice do quadro atual ultrapassou o número total de quadros na animação. Se sim, volta ao primeiro quadro.
        ...
        else
        {
            ...
            { // Verifica se tempo decorrido é maior ou igual ao tempo que o quadro atual deve ser exibido.
                ...
                if (currentFrameInseto >= frameCountInsetoMorto)
                { // Verifica se o índice do quadro atual ultrapassou o número total de quadros na animação. Se sim, volta ao primeiro quadro.
        ...
        { // Verifica se tempo decorrido é maior ou igual ao tempo que o quadro atual deve ser exibido.
            ...
            if (currentFrameBoss >= frameCountBoss)
            { // Verifica se o índice do quadro atual ultrapassou o número total de quadros na animação. Se sim, volta ao primeiro quadro.
                currentFrameBoss = 0;
            }
        ...
        { // Verifica se tempo decorrido é maior ou igual ao tempo que o quadro atual deve ser exibido.
            ...
            if (currentFramefireboll >= frameCountfireboll)
            { // Verifica se o índice do quadro atual ultrapassou o número total de quadros na animação. Se sim, volta ao primeiro quadro.
        ...
        if (elapsed_flor >= frameTime_flor)
        { // Verifica se tempo decorrido é maior ou igual ao tempo que o quadro atual deve ser exibido.

            currentFrameflorhit++; // Incrementa o índice do quadro atual.

            if (currentFrameflorhit >= frameCountflorhit)
            { // Verifica se o índice do quadro atual ultrapassou o número total de quadros na animação. Se sim, volta ao primeiro quadro.
